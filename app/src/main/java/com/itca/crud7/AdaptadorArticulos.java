...
//Añadimos un contructor a partir de las propiedades definidas en esta clase (AdaptadorArticulos).
...
//en la vista (Layout o xml) Personalizado. Este es el diseño personalizado para pinta cada registro en el recyclerview.
