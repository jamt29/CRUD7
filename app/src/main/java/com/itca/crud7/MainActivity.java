...
import com.itca.crud7.databinding.ActivityMainBinding;
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            new android.app.AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        //Un listenerque al pulsar, cierre la aplicacion
                        @Override
    ...
    public void bajaporcodigo(View v) {
        ...
        if (inputEt) {
            ...
            if (conexion.bajaCodigo(MainActivity.this, datos)) {
                //Toast.makeText(this, "Registro eliminado satisfactoriamente.",
                // Toast.LENGTH_SHORT).show();
                limpiarDatos();
            } else {
                Toast.makeText(this, "No existe un artículo con dicho código.",
